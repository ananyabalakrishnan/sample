...
#input commands:
x = input("Enter value: ") # takes in an input an returns the input and what type the input is
print(x)
print(type(x))
stringword = input("Enter sentence: ") #takes in strings and returns the string along with the number of characters in input
print(stringword)
#len command:
print(len(stringword)) 
